  ...
  <div class="mx-auto text-white">
    <div class="bg-[url('@/assets/bg-1.jpeg')] bg-fixed bg-cover bg-center p-4 md:p-8">
      <div class="bg-black bg-opacity-80 p-4 mb-4 md:mb-8">
        <h1 class="text-2xl">BodySnatchers</h1>
      ...
      <div class="flex flex-wrap md:flex-nowrap">
        ...
        <div class="bg-black bg-opacity-80 p-4 w-full md:w-1/2 mb-4 md:ml-4">
          <h1 class="text-2xl">Adult</h1>
          <div class="w-16 my-2 mx-auto border-b-2 border-amber-600"></div>
          <h2 class="text-xl">Price</h2>
    ...
    <div class="p-4 md:p-8">
      <div class="flex flex-wrap bg-black bg-opacity-80 p-4">
        <iframe
        ...
        <div class="w-full md:w-1/3 pt-4 md:pt-0 md:pl-4 text-left">
          ...
          <div class="w-16 my-2 border-b-2 border-amber-600"></div>
          <p>
            BodySnatchers Boxing Ltd <br>
            19 Sea Road <br>
            Boscombe <br>
            Bournemouth  <br>
            BH5 1DH
